package com.codelabs.agrimate.screens.shared.signup.collector
...
@Composable
fun SignupCollectorScreen(
    modifier: Modifier = Modifier,
    navController: NavController,
    viewModel: SignupCollectorViewModel = hiltViewModel(),
) {
    ...
    if (uiState.isSuccess) {
        ...
        AGMessageDialogSuccess(
            onDismissRequest = { },
            title = "Daftar Pengepul Berhasil!",
...
private fun SignupContent(
    ...
    uiState: SignupCollectorUiState,
    onSignupClick: () -> Unit,
) {
    Column(
        modifier = modifier
        ...
        AGAuthTopBanner(title = "Daftar Akun Pengepul")

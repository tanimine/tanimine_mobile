...
@HiltViewModel
class SignupCollectorViewModel @Inject constructor(
    private val authUseCase: AuthUseCase,
    private val regionUseCase: RegionUseCase
) : ViewModel() {
    private val _uiState = MutableStateFlow(SignupCollectorUiState())
    val uiState: StateFlow<SignupCollectorUiState> = _uiState
